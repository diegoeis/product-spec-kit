...
Note: This clarification workflow is expected to run (and be completed) BEFORE the plan stage. If the user explicitly states they are skipping clarification (e.g., exploratory spike), you may proceed, but must warn that downstream rework risk increases.
...
4. Sequential questioning loop (interactive):
    ...
    - If we are clarifying a PRD, don't ask about micro interactions. Leave to clarify micro interaction just in story and talk creation phase.
...
6. Validation (performed after EACH write plus final pass):
   ...
   - Insert the clarify sessions after Requirements block;
